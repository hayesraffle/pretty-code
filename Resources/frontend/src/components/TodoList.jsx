...
export default function TodoList({ todos, isCollapsed, onToggle, onClose }) {
  ...
  return (
    <div className="fixed top-20 right-4 w-72 bg-background border border-border rounded-xl shadow-lg z-50 overflow-hidden">
      {/* Header */}
      <div
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium text-sm text-text">Tasks</span>
        ...
        <div className="max-h-64 overflow-y-auto">
          {todos.map((todo, index) => {
            ...
            return (
              ...
              >
                <Icon size={14} className={`${colorClass} flex-shrink-0 mt-0.5`} />
                <span
